...
- `model_registry`: `d3872249454756e1370b6f119ddf0b59ca5bd98c703bfc4f6c6adf89f09acad2` (`model_registry.json`)
- `runtime_registry`: `f6eb2d8e9c866523299515e218229d0b17bd649022d45dd39c6ec32fafa5e041` (`runtime_registry.json`)

## Next Actions

- [x] Candidate manifests passed the dry-run gate; run the pin command without `--check` after review.
